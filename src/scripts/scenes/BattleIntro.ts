export default class BattleIntro extends Phaser.Scene {
    ...
    create() {
        ...
        var introText = this.add.text(width / 2 - 200 + 25, height / 2 - 200 + 75, "You've been thrown into battle! \n\nBe prepared to fight your opponent!", specStyle);
